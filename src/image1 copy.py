...
def detect_red(image):
  return detect_colour(image, RED_LOWER, RED_UPPER) #End effector

def detect_blue(image):
  return detect_colour(image, BLUE_LOWER, BLUE_UPPER) #Joint 2 & 3

def detect_green(image):
  return detect_colour(image, GREEN_LOWER, GREEN_UPPER) #Joint 4

def detect_yellow(image):
  return detect_colour(image, YELLOW_LOWER, YELLOW_UPPER)
...
class image_converter:
  ...
  def detect_end_effector(self, image) :
    ...
    endPos = a * (detect_red(image) - detect_yellow(image) - detect_green(image) - detect_blue(image))
    return endPos
